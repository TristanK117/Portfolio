            ...
            <ul>
                ...
                <li>
                    <div className="socials">
                        <a className="social-icon effect-shine" href="mailto:tristankhieu28@gmail.com" target="_blank">
                            <MailOutlineRoundedIcon style={{ fontSize: 25 }}></MailOutlineRoundedIcon>
                        </a>
                        <a className="social-icon effect-shine" href="https://github.com/TristanK117" target="_blank">
                            <GitHubIcon style={{ fontSize: 25 }}></GitHubIcon>
                        </a>
                        <a className="social-icon effect-shine" href="https://www.linkedin.com/in/tristan-khieu" target="_blank">
                            <LinkedInIcon style={{ fontSize: 25 }}></LinkedInIcon>
                        </a>
                        <a className="social-icon effect-shine" href="https://www.instagram.com/trstnkhu/" target="_blank">
                            <InstagramIcon style={{ fontSize: 25 }}></InstagramIcon>
                        </a>
                        <a className="social-icon effect-shine" href="https://open.spotify.com/user/tristankhieu" target="_blank">
